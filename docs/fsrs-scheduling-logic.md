...
| Backend (`apps/backend/src/scheduling/index.ts`) | iOS (`apps/ios/Flashcards/Flashcards/FsrsScheduler.swift`) |
| --- | --- |
...
| Backend | iOS |
| --- | --- |
| `apps/backend/src/cards/reviews.ts::toReviewableCardScheduleState` | `apps/ios/Flashcards/Flashcards/FsrsScheduler.swift::makeReviewableCardScheduleState(card:)` |
