...
const esMxCatalog: TranslationCatalog = {
  ...
  openSourceSettings: {
    ...
    thirdPartyNoticeDescription: "Animaciones Lottie de repaso: Free Unicorn Animation, Free Snail Animation, Free Rainbow Animation, Free Worm Animation y Free Wilted Flower Animation de Google Inc., Copyright © 2026 Google Inc., usadas bajo Creative Commons Attribution 4.0. Los runtimes de Lottie usan licencias MIT y Apache 2.0.",
