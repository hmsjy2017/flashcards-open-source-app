...
export const jaCatalog = {
  ...
  openSourceSettings: {
    ...
    thirdPartyNoticeDescription: "レビュー用Lottieアニメーション: Google Inc. の Free Owl Animation、Free Poodle Animation、Free Whale Animation、Free Peacock Animation、Free Unicorn Animation、Free Rainbow Animation、Copyright © 2026 Google Inc.。Creative Commons Attribution 4.0 の下で使用しています。Lottie ランタイムは MIT および Apache 2.0 ライセンスを使用しています。",
