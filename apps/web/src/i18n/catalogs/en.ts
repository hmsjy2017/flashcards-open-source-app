const enCatalog = {
  ...
  openSourceSettings: {
    ...
    thirdPartyNoticeDescription: "Review Lottie animations: Free Unicorn Animation, Free Snail Animation, Free Rainbow Animation, Free Worm Animation, and Free Wilted Flower Animation by Google Inc., Copyright © 2026 Google Inc., used under Creative Commons Attribution 4.0. Lottie runtimes use MIT and Apache 2.0 licenses.",
