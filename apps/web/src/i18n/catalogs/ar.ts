...
const arCatalog: TranslationCatalog = {
  ...
  openSourceSettings: {
    ...
    thirdPartyNoticeDescription: "رسوم متحركة ليونيكورن المراجعة: Free Unicorn Animation من Google Inc.، Copyright © 2026 Google Inc.، مستخدمة بموجب Creative Commons Attribution 4.0. تستخدم أوقات تشغيل Lottie تراخيص MIT وApache 2.0.",
    thirdPartyNoticeFullAction: "فتح الإشعارات الكاملة",
    thirdPartyNoticeSourceAction: "فتح مصدر الأصل",
