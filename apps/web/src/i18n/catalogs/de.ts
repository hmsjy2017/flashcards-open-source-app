...
const deCatalog: TranslationCatalog = {
  ...
  openSourceSettings: {
    ...
    thirdPartyNoticeDescription: "Review-Lottie-Animationen: Free Owl Animation, Free Poodle Animation, Free Whale Animation, Free Peacock Animation, Free Unicorn Animation und Free Rainbow Animation von Google Inc., Copyright © 2026 Google Inc., verwendet unter Creative Commons Attribution 4.0. Lottie-Laufzeiten verwenden MIT- und Apache-2.0-Lizenzen.",
