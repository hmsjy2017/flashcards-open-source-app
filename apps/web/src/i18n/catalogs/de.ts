...
const deCatalog: TranslationCatalog = {
  ...
  openSourceSettings: {
    ...
    thirdPartyNoticeDescription: "Review-Einhornanimation: Free Unicorn Animation von Google Inc., Copyright © 2026 Google Inc., verwendet unter Creative Commons Attribution 4.0. Lottie-Laufzeiten verwenden MIT- und Apache-2.0-Lizenzen.",
    thirdPartyNoticeFullAction: "Vollständige Hinweise öffnen",
    thirdPartyNoticeSourceAction: "Asset-Quelle öffnen",
