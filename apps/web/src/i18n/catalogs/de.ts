...
const deCatalog: TranslationCatalog = {
  ...
  progressScreen: {
    ...
    streakLeaderboard: {
      ...
      info: "Deine aktuellen Streak-Tage bestimmen deinen Rang. Wenn der öffentliche Snapshot noch nicht verfügbar ist, wird dein lokaler aktueller Streak angezeigt.",
      updatedAt: "Vor {{minutes}} min aktualisiert",
