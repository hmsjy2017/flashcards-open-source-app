...
export const zhHansCatalog = {
  ...
  openSourceSettings: {
    ...
    thirdPartyNoticeDescription: "复习 Lottie 动画：Google Inc. 的 Free Owl Animation、Free Poodle Animation、Free Whale Animation、Free Peacock Animation、Free Unicorn Animation 和 Free Rainbow Animation，Copyright © 2026 Google Inc.，依据 Creative Commons Attribution 4.0 使用。Lottie 运行时使用 MIT 和 Apache 2.0 许可证。",
