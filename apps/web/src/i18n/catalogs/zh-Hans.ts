...
export const zhHansCatalog = {
  ...
  openSourceSettings: {
    ...
    thirdPartyNoticeDescription: "复习独角兽动画：Google Inc. 的 Free Unicorn Animation，Copyright © 2026 Google Inc.，依据 Creative Commons Attribution 4.0 使用。Lottie 运行时使用 MIT 和 Apache 2.0 许可证。",
    thirdPartyNoticeFullAction: "打开完整声明",
    thirdPartyNoticeSourceAction: "打开素材来源",
