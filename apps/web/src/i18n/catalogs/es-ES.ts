...
const esEsCatalog: TranslationCatalog = {
  ...
  openSourceSettings: {
    ...
    thirdPartyNoticeDescription: "Animación de unicornio de repaso: Free Unicorn Animation de Google Inc., Copyright © 2026 Google Inc., usada bajo Creative Commons Attribution 4.0. Los runtimes de Lottie usan licencias MIT y Apache 2.0.",
    thirdPartyNoticeFullAction: "Abrir avisos completos",
    thirdPartyNoticeSourceAction: "Abrir fuente del recurso",
