...
const esEsCatalog: TranslationCatalog = {
  ...
  openSourceSettings: {
    ...
    thirdPartyNoticeDescription: "Animaciones Lottie de repaso: Free Unicorn Animation y Free Rainbow Animation de Google Inc., Copyright © 2026 Google Inc., usadas bajo Creative Commons Attribution 4.0. Los runtimes de Lottie usan licencias MIT y Apache 2.0.",
