...
const hiCatalog: TranslationCatalog = {
  ...
  openSourceSettings: {
    ...
    thirdPartyNoticeDescription: "रिव्यू Lottie एनीमेशन: Google Inc. के Free Unicorn Animation, Free Snail Animation, Free Rainbow Animation, Free Worm Animation, Free Tornado Animation और Free Wilted Flower Animation, Copyright © 2026 Google Inc., Creative Commons Attribution 4.0 के तहत उपयोग किए गए। Lottie रनटाइम MIT और Apache 2.0 लाइसेंस का उपयोग करते हैं।",
