...
// Keep in sync with apps/backend/src/scheduling/index.ts::FsrsCardState, apps/web/src/types.ts::FsrsCardState, and apps/ios/Flashcards/Flashcards/Review/FsrsTypes.swift::FsrsCardState.
...
// Keep in sync with apps/backend/src/scheduling/workspaceConfig.ts::WorkspaceSchedulerSettings, apps/web/src/types.ts::WorkspaceSchedulerSettings, and apps/ios/Flashcards/Flashcards/Review/FsrsTypes.swift::WorkspaceSchedulerSettings.
data class WorkspaceSchedulerSettings(
    val workspaceId: String,
    val algorithm: String,
    val desiredRetention: Double,
...
// Keep in sync with apps/backend/src/scheduling/index.ts::ReviewSchedule, apps/ios/Flashcards/Flashcards/FsrsScheduler.swift::ReviewSchedule, and the Android scheduler mirror in FsrsScheduler.kt.
