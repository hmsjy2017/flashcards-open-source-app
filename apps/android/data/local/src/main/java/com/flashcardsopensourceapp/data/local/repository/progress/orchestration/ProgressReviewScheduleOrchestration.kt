...
import com.flashcardsopensourceapp.data.local.repository.progress.snapshots.ProgressReviewScheduleSyncRefreshTrackerState
import com.flashcardsopensourceapp.data.local.repository.progress.snapshots.createProgressReviewScheduleScopeKey
import com.flashcardsopensourceapp.data.local.repository.progress.snapshots.createProgressReviewScheduleStoreState
import com.flashcardsopensourceapp.data.local.repository.progress.snapshots.createReviewScheduleFingerprint
...
import com.flashcardsopensourceapp.data.local.repository.progress.snapshots.validateProgressReviewScheduleResponseTimeZone
    ...
    private suspend fun performRefresh(
        ...
        if (syncMode == ProgressRemoteRefreshSyncMode.SYNC_BEFORE_REMOTE_LOAD) {
            try {
                ...
                logProgressRefreshWarning(
                    ...
                    source = "review_schedule_sync_before_remote_load",
                    fields = listOf(
        ...
        try {
            ...
            logProgressRefreshWarning(
                ...
                scopeId = resolvedRefreshStoreState.scopeKey.scopeId,
                source = "review_schedule_remote_response",
                fields = listOf(
                    "scopeKey" to serializeProgressReviewScheduleScopeKey(
                        scopeKey = resolvedRefreshStoreState.scopeKey
                    ),
