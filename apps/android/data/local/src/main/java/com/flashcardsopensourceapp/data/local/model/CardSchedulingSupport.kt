...
// Keep in sync with apps/backend/src/cards/reviews.ts::toReviewableCardScheduleState and apps/ios/Flashcards/Flashcards/FsrsScheduler.swift::makeReviewableCardScheduleState(card:).
