...
ANDROID_SENTRY_DSN_VALUE="$(require_non_empty_value "${ANDROID_SENTRY_DSN:-}" "Set ANDROID_SENTRY_DSN in root .env before running setup-github-android.sh.")"
ANDROID_SENTRY_TRACES_SAMPLE_RATE_VALUE="${ANDROID_SENTRY_TRACES_SAMPLE_RATE:-}"
SENTRY_ORG_VALUE="$(require_non_empty_value "${SENTRY_ORG:-}" "Set SENTRY_ORG in root .env before running setup-github-android.sh.")"
SENTRY_ANDROID_PROJECT_VALUE="$(require_non_empty_value "${SENTRY_ANDROID_PROJECT:-}" "Set SENTRY_ANDROID_PROJECT in root .env before running setup-github-android.sh.")"
...
gh variable set ANDROID_SENTRY_DSN --body "${ANDROID_SENTRY_DSN_VALUE}" --repo "${REPO}"
...
set_secret_if_present SENTRY_AUTH_TOKEN "${SENTRY_AUTH_TOKEN_VALUE}"
