...
| --- | --- | --- | --- | --- |
| lottie-web | Web app review reaction animations | MIT | `apps/web/node_modules/lottie-web/LICENSE.md` | https://github.com/airbnb/lottie-web |
| lottie-ios | iOS app review reaction animations | Apache License 2.0 | `apps/ios/Flashcards/third-party/lottie-ios-LICENSE.md` | https://github.com/airbnb/lottie-ios |
| lottie-android | Android app review reaction animations | Apache License 2.0 | `apps/android/third-party/lottie-android-LICENSE.md` | https://github.com/airbnb/lottie-android |
